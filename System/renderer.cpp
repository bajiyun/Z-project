...
ID3D11Buffer*			CRenderer::m_SpotLightBuffer = NULL;
...
void CRenderer::Init()
{
	...
	hBufferDesc.ByteWidth = sizeof(LightBuffer);
	ID3D11Buffer*	 m_LightBuffer = CLight::GetLightBuffer();

	m_D3DDevice->CreateBuffer(&hBufferDesc, NULL, &m_LightBuffer);
	m_ImmediateContext->VSSetConstantBuffers(7, 1, &m_LightBuffer);
	m_ImmediateContext->PSSetConstantBuffers(7, 1, &m_LightBuffer);
...
void CRenderer::Begin()
{
	...
	// バックバッファクリア
	float ClearColor[4] = { 0.175f, 0.175f, 0.175f, 1.0f };
...
//void CRenderer::SetLightBuffer(LightBuffer lightbuffer)
//{
