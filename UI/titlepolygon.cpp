...
void CTPolygon::Init()
{
	...
	vertex[1].Diffuse = D3DXVECTOR4(1.0f, 0.8f, 0.8f, 1.0f);
	vertex[1].TexCoord = D3DXVECTOR2(1.0f, 0.0f);

	vertex[2].Position = D3DXVECTOR3(0.0f, 540.0f, 0.0f);
	vertex[2].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	vertex[2].Diffuse = D3DXVECTOR4(0.7f, 0.5f, 0.5f, 1.0f);
	vertex[2].TexCoord = D3DXVECTOR2(0.0f, 1.0f);

	vertex[3].Position = D3DXVECTOR3(960.0f, 540.0f, 0.0f);
	vertex[3].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	vertex[3].Diffuse = D3DXVECTOR4(0.7f, 0.5f, 0.5f, 1.0f);
...
void CTPolygon::Uninit()
{
	m_VertexBuffer->Release();
	m_Texture->Release();
}

void CTPolygon::Update()
{
}
